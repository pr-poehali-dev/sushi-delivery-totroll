    ...
    <Sheet>
      <SheetTrigger asChild>
        ...
        >
          ...
          {!isMobile && <span className="ml-2">Корзина</span>}
        </Button>
      </SheetTrigger>
      <SheetContent side="right" className="w-full sm:w-96">
        ...
        {cartItems.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-64">
            ...
            <p className="text-gray-400 text-sm mt-2">Добавьте что-нибудь вкусненькое</p>
          </div>
        ) : (
          <div className="mt-6">
        ...
        <SheetFooter className="mt-6">
          <Button disabled={cartItems.length === 0} className="w-full bg-red-600 hover:bg-red-700">
            Оформить заказ
          </Button>
        </SheetFooter>
      </SheetContent>
